import { Avatar, Button, Container, Grid, IconButton, Skeleton, Typography } from "@mui/material";
  ...
  <Container className="container">
    <Grid container={true} paddingTop={'2rem'}>
      <Grid item={true} xs={12} display={'flex'} alignItems={'center'} >
        <Button variant="outlined" fullWidth={true} onClick={loginWithGitHub}>Login With GIT HUB</Button> 
...
<Skeleton variant="rounded" width={210} height={60} />
       ...
       <Grid item={true} xs={12} paddingTop={'2rem'} display={'flex'} alignItems={'center'} >
        <Button variant="outlined" fullWidth={true} onClick={getUserData}>Get User Data</Button>
        <Button variant="outlined" fullWidth={true} onClick={() => {localStorage.removeItem('acessToken'); setRerender(!reRender)}}>LogOut</Button>
      {userInfo.map((data)=>{
